...
const CType = [
  "[Please Select]",
  "Solidity (Single file/concatenated method)",
...
export default function VerifyContract({ address }: Props) {
  ...
  const handleReset = () => {
    if (
      isVerify.contract != "" &&
      isVerify.compiler_type != "" &&
      isVerify.compiler_version != "" &&
      isVerify.license != ""
    ) {
  ...
  return (
    <Flex minHeight={"100vh"} direction={"column"} bgColor="lightest">
      ...
      <Box>
        ...
        >
          <Text
            style={{ fontSize: "32px", fontWeight: "bold", marginTop: "30px" }}
          >
            Verify & Publish Contract Source Code
          </Text>
          {!selectedVerify && (
            <Text style={{ fontSize: "16px", color: "#8C95A4" }}>
      ...
      {selectedVerify && (
        <Box px={6} pt={3} style={{ display: "flex", alignItems: "center" }}>
          ...
          "Solidity (Single file/concatenated method)" ? (
            <Text
              style={{ fontSize: "14px", color: "#6c757e", fontWeight: "bold" }}
            >
              A simple and structured interface for verifying smart contracts
              that fit in a single file
            </Text>
          ) : isVerify.compiler_type === "Solidity (Multi-Part files)" ? (
            <Text
              style={{ fontSize: "14px", color: "#6c757e", fontWeight: "bold" }}
            ...
            <Box style={{ display: "flex" }}>
              ...
              >
                is the recommended way to interface with the Solidity compiler
                especially for more complex and automated setups.
              </Text>
            </Box>
          ) : null}
        </Box>
        ...
        <Box>
          ...
          >
            ...
            >
              ...
              escan.live will match the compiled code with that on the
              blockchain. Just like contracts, a &quot;smart contract&quot;
              should provide end users with more information on what they are
              &ldquo;digitally signing&rdquo; for and give users an opportunity
              to audit the code to independently verify that it actually does
          ...
          >
            ...
            >
              ...
              <Input
                ...
                onChange={(e) => handleChange_verify(e, "contract")}
              ></Input>
            </Box>
            ...
            >
              ...
              <Box style={{ width: "50%" }}>
                <Select
                  ...
                  onChange={(e) => handleChange_verify(e, "compiler_type")}
                >
            ...
            >
              ...
              <Box style={{ width: "50%" }}>
                <Select
                  defaultValue={selectedOption}
                  onChange={(e) => handleChange_verify(e, "compiler_version")}
                >
            ...
            >
              ...
              <Box style={{ width: "50%" }}>
                <Select
                  defaultValue={selectedOption}
                  onChange={(e) => handleChange_verify(e, "license")}
                >
            ...
            >
              <Button
                onClick={handleReset}
                style={{ marginRight: "10px", backgroundColor: "#1a90ff" }}
              >
                Continue
              </Button>
              <Button
                    ...
                    <TabPanel>
                      <Box style={{ display: "flex" }}>
                        ...
                        <Box style={{ width: "50%" }}>
                          ...
                          <Input
                            style={{ backgroundColor: "#f8fafd" }}
                            value={isVerify.compiler_version}
                            readOnly
                          ></Input>
                        </Box>
                      </Box>
