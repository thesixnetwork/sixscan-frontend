...
const ENV = {
  ...
  ARCH_API_URL: process.env.ARCH_API_URL || process.env.API_URL || "https://api1.fivenet.sixprotocol.net",
  ARCH_RPC_URL: process.env.ARCH_RPC_URL || process.env.RPC_URL || "https://rpc2.fivenet.sixprotocol.net",
  NEXT_PUBLIC_CHAIN_NAME: process.env.NEXT_PUBLIC_CHAIN_NAME || "",
  TXS_API_URL: process.env.TXS_API_URL || "https://six-protocol-get-txs-api-gateway-7kl45r91.ts.gateway.dev/",
